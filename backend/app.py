...
from routes.assessment_analysis import router as assessment_analysis_router
...
app.include_router(assessment_analysis_router, prefix="/analyze-assessment", tags=["Assessment Analysis"])
